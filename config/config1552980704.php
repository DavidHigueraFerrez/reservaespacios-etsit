...
$conf['settings']['admin.email'] = 'david.higuera.ferrez@alumnos.upm.es';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://dev.etsit.upm.es/reservaespacios/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['password'] = '123secret';
 ...
 */
$conf['settings']['install.password'] = '123secret';
/**
 * Pages
 */
