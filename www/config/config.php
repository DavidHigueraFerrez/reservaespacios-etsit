...
$conf['settings']['script.url'] = getenv('PORTAL_PROD_URL');
...
$conf['settings']['home.url'] = getenv('PORTAL_PROD_URL');
...
$conf['settings']['ics']['subscription.key'] = '4db97354d0a0e7787752';
...
$conf['settings']['database']['type'] = getenv('SETTING_DATABASE_TYPE');
$conf['settings']['database']['user'] = getenv('SETTING_DATABASE_USER');
$conf['settings']['database']['password'] = getenv('SETTING_DATABASE_PASSWORD');
$conf['settings']['database']['hostspec'] = getenv('SETTING_DATABASE_HOSTSPEC');
$conf['settings']['database']['name'] = getenv('SETTING_DATABASE_NAME');
$conf['settings']['phpmailer']['mailer'] = 'smtp';
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.etsit.upm.es';
$conf['settings']['phpmailer']['smtp.port'] = '587';
$conf['settings']['phpmailer']['smtp.secure'] = 'STARTTLS';
$conf['settings']['phpmailer']['smtp.auth'] = 'true';
$conf['settings']['phpmailer']['smtp.username'] = 'zz.mailer.sys2';
$conf['settings']['phpmailer']['smtp.password'] = 'CJv9IfiBSE3VcB0rdB3n';
...
$conf['settings']['email']['default.from.address'] = 'noreply@etsit.upm.es';
$conf['settings']['email']['default.from.name'] = 'reserva-espacios-ETSIT';
...
$conf['settings']['reservation.labels']['ics.my.summary'] = '{title}<span>Esto es una solicitud, reserva pendiente de confirmación</span>';
