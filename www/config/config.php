...
//$conf['settings']['script.url'] = 'http://dev.etsit.upm.es/reservaespacios/Web';
...
//$conf['settings']['home.url'] = 'https://dev.etsit.upm.es/reservaespacios/Web/view-schedule.php';
...
$conf['settings']['database']['hostspec'] = 'mysql';
